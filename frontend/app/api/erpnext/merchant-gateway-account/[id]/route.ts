...
// GET - Get one merchant gateway account
export async function GET(
  ...
  try {
    ...
    const url = getErpNextUrl.MERCHANT_GATEWAY_ACCOUNT_BY_ID(id);
    ...
    console.error("ERPNext merchant gateway account get error:", error);
    return NextResponse.json(
      {
        message:
...
// PUT - Update merchant gateway account
export async function PUT(
  ...
  try {
    ...
    console.error("ERPNext merchant gateway account update error:", error);
    return NextResponse.json(
      {
        message:
          error instanceof Error ? error.message : "Internal server error",
...
// DELETE - Delete merchant gateway account
export async function DELETE(
  ...
  try {
    ...
    console.error("ERPNext merchant gateway account delete error:", error);
    return NextResponse.json(
      {
        message:
          error instanceof Error ? error.message : "Internal server error",
