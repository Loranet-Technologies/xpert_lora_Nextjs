...
interface ResetPasswordModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: { target_user_name: string; new_password: string; logout_all_sessions: number }) => void;
  user?: any;
  isLoading?: boolean;
}
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="text-sm text-muted-foreground">
            Reset password for <strong>{user?.email || user?.full_name || 'this user'}</strong>
          </div>
          ...
          <div>
            ...
            {!passwordError && formData.new_password && formData.new_password.length >= 8 && (
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button
              ...
              disabled={isLoading || !!passwordError || !!confirmPasswordError || !formData.new_password || !formData.confirm_password}>
              {isLoading ? (
                <>
